export default {
	...
	product: {
		...
		channelHint: 'Kênh là nơi mà sản phẩm ủa bạn sẽ được công bố.',
		priceHint: 'Giá là giá bán ra của mỗi phân loại sản phẩm.',
		costPriceHint: 'Giá trị là giá đầu vào của từng phân loại sản phẩm.',
		stockHint: 'Trữ lượng là số hàng bạn còn lại trong kho.',
