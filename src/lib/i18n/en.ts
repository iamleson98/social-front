export default {
	...
	giftcard: {
		...
		confirmDelete: 'Are you sure you want to delete the selected gift cards?',
		confirmDeactivate: 'Are you sure you want to deactivate the selected gift cards?',
		event: 'Gift Card Events',
		...
		events: {
			...
			noEvents: 'No events found for this gift card'
		}
	},
	channel: {
