...
export const CHECKOUT_DETAIL_FRAGMENT = gql`
        fragment CheckoutDetailFragment on Checkout {
                ...
                chargeStatus
                isShippingRequired
                # Selected delivery for this checkout (Saleor 3.23+). The payment
                # gateway list is resolved by paymentGatewayInitialize.
                delivery {
                        id
                        shippingMethod {
                                id
...
export const CHECKOUT_REMOVE_PROMO_CODE_MUTATION = gql`
        mutation CheckoutRemovePromoCode($id: ID, $promoCode: String, $promoCodeId: ID) {
