...
/*
 * `orderVoid` and `orderCapture` were removed with the legacy Payments API
 * (Saleor 3.24). Use `ORDER_TRANSACTION_REQUEST_ACTION_MUTATION` with
 * `TransactionActionEnum.Void` / `.Capture` instead.
 */
