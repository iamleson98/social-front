...
/*
 * `exportGiftCards` was REMOVED in Saleor 3.24 — CSV/XLSX export is no longer
 * part of the core API. Exports should be handled by a dedicated app or from
 * the Saleor dashboard instead.
 */
