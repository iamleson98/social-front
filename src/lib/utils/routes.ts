...
export const AppRoute = {
	...
	SETTING_ORDERS_SHOP: () => buildLinkWithRespectToChannel('settings/orders'),
	SETTING_ORDERS_SHOP_NEW: () => buildLinkWithRespectToChannel('settings/orders/new'),
	SETTING_ORDERS_SHOP_DETAILS: (id: string) => buildLinkWithRespectToChannel(`settings/orders/${id}`),
