...
export const AppRoute = {
	...
	SETTINGS_PRODUCTS_EDIT: (slug: string) =>
		buildLinkWithRespectToChannel(`settings/products/${slug}`),
	...
	SETTINGS_PRODUCT_TYPE_EDIT: (id: string) =>
		buildLinkWithRespectToChannel(`settings/product-types/${id}`),
	...
	SETTINGS_CONFIGS_CHANNEL_DETAILS: (slug: string) =>
		buildLinkWithRespectToChannel(`settings/channels/${slug}`),
	SETTINGS_CONFIGS_CHANNEL_NEW: () =>
		buildLinkWithRespectToChannel('settings/channels/new-channel'),

	SETTINGS_CONFIGS_STAFFS: () => buildLinkWithRespectToChannel('settings/staffs'),
	SETTINGS_CONFIGS_STAFF_DETAILS: (id: string) =>
		buildLinkWithRespectToChannel(`settings/staffs/${id}`),
	...
	SETTINGS_CONFIGS_USER_DETAILS: (id: string) =>
		buildLinkWithRespectToChannel(`settings/customers/${id}`),
	...
	SETTINGS_SHOP_ORDER_SETTINGS: (chanSlug?: string) =>
		buildLinkWithRespectToChannel(
			`settings/shop-orders/configs${chanSlug ? `?chan=${chanSlug}` : ''}`,
		),
	SETTINGS_ORDERS_NEW: () => buildLinkWithRespectToChannel('settings/shop-orders/new'),
	SETTINGS_ORDERS_DETAILS: (id: string) =>
		buildLinkWithRespectToChannel(`settings/shop-orders/${id}`),
	...
	SETTINGS_CONFIGS_COLLECTION_DETAILS: (id: string) =>
		buildLinkWithRespectToChannel(`settings/collections/${id}`),
	...
	SETTINGS_CONFIGS_WAREHOUSE_DETAILS: (id: string) =>
		buildLinkWithRespectToChannel(`settings/warehouses/${id}`),
	...
	SETTINGS_CONFIGS_SHIPPING_ZONE_DETAILS: (id: string) =>
		buildLinkWithRespectToChannel(`settings/shipping-zones/${id}`),
	SETTINGS_CONFIGS_SHIPPING_ZONE_NEW: () =>
		buildLinkWithRespectToChannel('settings/shipping-zones/new'),

	SETTINGS_CONFIGS_SHIPPING_ZONE_METHOD_DETAILS: (zoneId: string, id: string) =>
		buildLinkWithRespectToChannel(`settings/shipping-zones/${zoneId}/methods/${id}`),
	SETTINGS_CONFIGS_SHIPPING_ZONE_METHOD_NEW: (zoneId: string, type: ShippingMethodTypeEnum) =>
		buildLinkWithRespectToChannel(`settings/shipping-zones/${zoneId}/methods/new?type=${type}`),

	SETTINGS_CONFIGS_ATTRIBUTES: () => buildLinkWithRespectToChannel('settings/attributes'),
	SETTINGS_CONFIGS_ATTRIBUTE_DETAILS: (id: string) =>
		buildLinkWithRespectToChannel(`settings/attributes/${id}`),
	...
	SETTINGS_CONFIGS_GIFTCARD_NEW: (customerEmail?: string) =>
		buildLinkWithRespectToChannel(
			customerEmail
				? `settings/giftcards/new?customerEmail=${customerEmail}`
				: 'settings/giftcards/new',
		),
	SETTINGS_CONFIGS_GIFTCARD_DETAIL: (id: string) =>
		buildLinkWithRespectToChannel(`settings/giftcards/${id}`),
	...
	SETTINGS_CONFIGS_PROMOTION_DETAIL: (id: string) =>
		buildLinkWithRespectToChannel(`settings/promotions/${id}`),
	...
	SETTINGS_CONFIGS_VOUCHER_DETAIL: (id: string) =>
		buildLinkWithRespectToChannel(`settings/vouchers/${id}`),

	SETTINGS_CONFIGS_PERMISSION_GROUPS: () =>
		buildLinkWithRespectToChannel('settings/permission-groups'),
	SETTINGS_CONFIGS_PERMISSION_GROUP_NEW: () =>
		buildLinkWithRespectToChannel('settings/permission-groups/new'),
	SETTINGS_CONFIGS_PERMISSION_GROUP_DETAIL: (id: string) =>
		buildLinkWithRespectToChannel(`settings/permission-groups/${id}`),
	...
	TAX_SETTINGS_TAX_CLASSES: () =>
		buildLinkWithRespectToChannel('settings/tax-settings/tax-classes'),
	TAX_SETTINGS_CHANNELS: () => buildLinkWithRespectToChannel('settings/tax-settings/channels'),
	TAX_SETTINGS_CHANNEL_DETAILS: (id: string) =>
		buildLinkWithRespectToChannel(`settings/tax-settings/channels/${id}`),
	TAX_SETTINGS_COUNTRY_DETAILS: (code: string) =>
		buildLinkWithRespectToChannel(`settings/tax-settings/countries?code=${code}`),
	TAX_SETTINGS_TAX_CLASS_DETAILS: (id: string) =>
		buildLinkWithRespectToChannel(`settings/tax-settings/tax-classes?id=${id}`),
	...
	PRODUCT_ATTRIBUTES: (slug: string) =>
		buildLinkWithRespectToChannel(`products/${slug}/attributes`),
	PRODUCT_FEEDBACKS: (slug: string) =>
		buildLinkWithRespectToChannel(`products/${slug}/customer-feedbacks`),
	...
	CATEGORY_DETAILS_TAB: (slug: string, tab: string) =>
		buildLinkWithRespectToChannel(`categories/${slug}?tab=${tab}`),
	SUB_CATEGORIES: (slug: string) =>
		buildLinkWithRespectToChannel(`categories/${slug}/sub-categories`),
