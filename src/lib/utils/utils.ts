...
let _counter = 0;
/**
 * Generates a unique DOM-friendly id.
 * NOTE: the module counter alone is NOT unique across server instances or a
 * re-ordered SSR hydration, so it is salted with `crypto.randomUUID` on the
