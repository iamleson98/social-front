<svg xmlns="http://www.w3.org/2000/svg" width="1rem" height="1rem" viewBox="0 0 64 64"
	><path fill="#e81111" d="M48 6.6C43.3 3.7 37.9 2 32 2v4.6z" /><path
		fill="#fff"
		d="M32 11.2h21.6C51.9 9.5 50 7.9 48 6.6H32z"
	/><path fill="#e81111" d="M32 15.8h25.3c-1.1-1.7-2.3-3.2-3.6-4.6H32z" /><path
		fill="#fff"
		d="M32 20.4h27.7c-.7-1.6-1.5-3.2-2.4-4.6H32z"
	/><path fill="#e81111" d="M32 25h29.2c-.4-1.6-.9-3.1-1.5-4.6H32z" /><path
		fill="#fff"
	...
	/><path fill="#e81111" d="M32 62c5.9 0 11.4-1.7 16.1-4.7H15.9c4.7 3 10.2 4.7 16.1 4.7" /><path
		fill="#3e79ce"
