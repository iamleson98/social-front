<script lang="ts">
	...
	let { dimension = 32 }: Props = $props();
</script>

<svg xmlns="http://www.w3.org/2000/svg" width={dimension} height={dimension} viewBox="0 0 64 64"
	><path
		fill="#b2c1c0"
	...
	/><circle cx="12.3" cy="56.4" r="5.6" fill="#62727a" /><circle
		...
		r="2.8"
		fill="#fff"
	/><circle cx="46.1" cy="56.4" r="5.6" fill="#62727a" /><path
		fill="#fff"
		d="M48.9 56.4c0 1.6-1.3 2.8-2.8 2.8c-1.6 0-2.8-1.3-2.8-2.8c0-1.6 1.3-2.8 2.8-2.8s2.8 1.2 2.8 2.8"
	/><path fill="#62727a" d="M61.1 2h-2.8v5.6h2.8c.5 0 .9-.4.9-.9V2.9c0-.5-.4-.9-.9-.9" /><path
		fill="#f15744"
