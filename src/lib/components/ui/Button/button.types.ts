...
export const buttonVariantColorsMap: Record<ButtonVariant, Record<SocialColor, string>> = {
  ...
  gradient: {
    dark: 'text-white bg-gradient-to-r from-gray-900 to-gray-800 focus:ring-gray-200',
    gray: 'text-white bg-gradient-to-r from-gray-500 to-gray-400 focus:ring-gray-200',
    red: 'text-white bg-gradient-to-r from-red-500 to-red-400 focus:ring-red-200',
    pink: 'text-white bg-gradient-to-r from-pink-500 to-pink-400 focus:ring-pink-200',
    grape: 'text-white bg-gradient-to-r from-purple-500 to-purple-400 focus:ring-purple-200',
    violet: 'text-white bg-gradient-to-r from-violet-500 to-violet-400 focus:ring-violet-200',
    indigo: 'text-white bg-gradient-to-r from-indigo-500 to-indigo-400 focus:ring-indigo-200',
    blue: 'text-white bg-gradient-to-r from-blue-500 to-blue-400 focus:ring-blue-200',
    cyan: 'text-white bg-gradient-to-r from-cyan-500 to-cyan-400 focus:ring-cyan-200',
    teal: 'text-white bg-gradient-to-r from-teal-500 to-teal-400 focus:ring-teal-200',
    green: 'text-white bg-gradient-to-r from-green-500 to-green-400 focus:ring-green-200',
    lime: 'text-white bg-gradient-to-r from-lime-500 to-lime-400 focus:ring-lime-200',
    yellow: 'text-white bg-gradient-to-r from-yellow-500 to-yellow-400 focus:ring-yellow-200',
    orange: 'text-white bg-gradient-to-r from-orange-500 to-orange-400 focus:ring-orange-200',
  }
};
