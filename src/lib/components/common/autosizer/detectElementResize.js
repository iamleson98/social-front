 ...
 * Sebastian Decima
 *
 * Vendored third-party code (v0.5.3) — deliberately kept as close to upstream
 * as possible apart from the listed modifications, so it is excluded from
 * type-checking instead of being rewritten with annotations.
 *
...
export function createDetectElementResize(nonce) {
