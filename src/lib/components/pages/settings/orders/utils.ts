...
/**
 * With the legacy Payments API removed (Saleor 3.24+), transactions are the
 * only payment representation on an order.
 */
...
export const getDeliveryMethodName = (order: Order, _T?: TranFunc) => {
...
export const getTaxTypeText = (order: Order, _T?: TranFunc) => {
...
export const getDiscountTypeLabel = (discount: OrderDiscount, _T?: TranFunc) => {
