...
export const GET: RequestHandler = async (event) => {
	// Public URL of the storefront; falls back to the request origin when
	// the variable is not configured in the deployment environment.
	const baseUrl = publicEnv.PUBLIC_STORE_FRONT_URL || event.url.origin;
