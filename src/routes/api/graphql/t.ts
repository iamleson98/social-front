...
type Query {
	...
	orderSettings: OrderSettings
		@doc(category: "Orders")
		@deprecated(
			reason: "This field will be removed in Saleor 4.0. Use the "channel" query to fetch the "orderSettings" field instead."
		)
	...
	sale(
		...
		@doc(category: "Discounts")
		@deprecated(
			reason: "This field will be removed in Saleor 4.0. Use the "promotion" query instead."
		)
	...
	sales(
		...
		@doc(category: "Discounts")
		@deprecated(
			reason: "This field will be removed in Saleor 4.0. Use the "promotions" query instead."
		)
	...
	taxTypes: [TaxType!]
		@doc(category: "Taxes")
		@deprecated(reason: "This field will be removed in Saleor 4.0. Use "taxClasses" field instead.")
...
type Webhook implements Node @doc(category: "Webhooks") {
	...
	secretKey: String
		@deprecated(
			reason: "This field will be removed in Saleor 4.0. As of Saleor 3.5, webhook payloads default to signing using a verifiable JWS."
		)
...
type App implements Node & ObjectWithMetadata @doc(category: "Apps") {
	...
	"""
	dataPrivacy: String
		@deprecated(reason: "This field will be removed in Saleor 4.0. Use "dataPrivacyUrl" instead.")
	...
	configurationUrl: String
		@deprecated(reason: "This field will be removed in Saleor 4.0. Use "appUrl" instead.")
...
type CountryDisplay {
	...
	vat: VAT
		@deprecated(
			reason: "This field will be removed in Saleor 4.0. Always returns "null". Use "TaxClassCountryRate" type to manage tax rates per country."
		)
}
...
type Product implements Node & ObjectWithMetadata @doc(category: "Products") {
	...
	chargeTaxes: Boolean!
		@deprecated(
			reason: "This field will be removed in Saleor 4.0. Use "Channel.taxConfiguration" field to determine whether tax collection is enabled."
		)
	...
	"""
	taxType: TaxType
		@deprecated(reason: "This field will be removed in Saleor 4.0. Use "taxClass" field instead.")
	...
	variant(
		...
		@deprecated(reason: "This field will be removed in Saleor 4.0. Use top-level "variant" query.")
	...
	"""
	images: [ProductImage!]
		@deprecated(reason: "This field will be removed in Saleor 4.0. Use the "media" field instead.")
...
type VariantPricingInfo @doc(category: "Products") {
	...
	discountLocalCurrency: TaxedMoney
		@deprecated(reason: "This field will be removed in Saleor 4.0. Always returns "null".")
...
type Shop implements ObjectWithMetadata {
	...
	includeTaxesInPrices: Boolean!
		@deprecated(
			reason: "This field will be removed in Saleor 4.0. Use "Channel.taxConfiguration.pricesEnteredWithTax" to determine whether prices are entered with tax."
		)
	...
	displayGrossPrices: Boolean!
		@deprecated(
			reason: "This field will be removed in Saleor 4.0. Use "Channel.taxConfiguration" to determine whether to display gross or net prices."
		)
	...
	chargeTaxesOnShipping: Boolean!
		@deprecated(
			reason: "This field will be removed in Saleor 4.0. Use "ShippingMethodType.taxClass" to determine whether taxes are calculated for shipping methods; if a tax class is set, the taxes will be calculated, otherwise no tax rate will be applied."
		)
}
...
type User implements Node & ObjectWithMetadata @doc(category: "Users") {
	...
	checkoutTokens(
		...
		@deprecated(reason: "This field will be removed in Saleor 4.0. Use "checkoutIds" instead.")
...
type Checkout implements Node & ObjectWithMetadata @doc(category: "Checkout") {
	...
	updatedAt: DateTime!
	lastChange: DateTime!
		@deprecated(reason: "This field will be removed in Saleor 4.0. Use "updatedAt" instead.")
	...
	availableShippingMethods: [ShippingMethod!]!
		@webhookEventsInfo(
			asyncEvents: []
			syncEvents: [SHIPPING_LIST_METHODS_FOR_CHECKOUT, CHECKOUT_FILTER_SHIPPING_METHODS]
		)
		@deprecated(reason: "This field will be removed in Saleor 4.0. Use "shippingMethods" instead.")
	...
	availablePaymentGateways: [PaymentGateway!]!
		@webhookEventsInfo(asyncEvents: [], syncEvents: [PAYMENT_LIST_GATEWAYS])
	...
	shippingMethod: ShippingMethod
		...
		@deprecated(reason: "This field will be removed in Saleor 4.0. Use "deliveryMethod" instead.")
...
type GiftCard implements Node & ObjectWithMetadata @doc(category: "Gift cards") {
	...
	"""
	user: User
		@deprecated(reason: "This field will be removed in Saleor 4.0. Use "createdBy" field instead.")

	"""
	End date of gift card.
	"""
	endDate: DateTime
		@deprecated(reason: "This field will be removed in Saleor 4.0. Use "expiryDate" field instead.")
...
type Order implements Node & ObjectWithMetadata @doc(category: "Orders") {
	...
	"""
	availableShippingMethods: [ShippingMethod!]
		@deprecated(reason: "Use "shippingMethods", this field will be removed in 4.0")
	...
	"""
	totalCaptured: Money!
		@deprecated(reason: "This field will be removed in Saleor 4.0. Use "totalCharged" instead.")
...
type Invoice implements ObjectWithMetadata & Job & Node @doc(category: "Orders") {
	...
	externalUrl: String
		@deprecated(
			reason: "This field will be removed in Saleor 4.0. Use "url" field.This field will be removed in 4.0"
		)
...
type Mutation {
	...
	stockBulkUpdate(
		...
		@doc(category: "Products")
		@webhookEventsInfo(asyncEvents: [PRODUCT_VARIANT_STOCK_UPDATED], syncEvents: [])
	...
	shopSettingsUpdate(
		...
		@doc(category: "Shop")
		@webhookEventsInfo(asyncEvents: [SHOP_METADATA_UPDATED], syncEvents: [])
	...
	productBulkTranslate(
		...
		@doc(category: "Products")
		@webhookEventsInfo(asyncEvents: [TRANSLATION_CREATED, TRANSLATION_UPDATED], syncEvents: [])
	...
	transactionEventReport(
		...
		@doc(category: "Payments")
		@webhookEventsInfo(
			asyncEvents: [TRANSACTION_ITEM_METADATA_UPDATED, CHECKOUT_FULLY_PAID, ORDER_UPDATED]
			syncEvents: []
		)
	...
	storedPaymentMethodRequestDelete(
		...
		@doc(category: "Payments")
		@webhookEventsInfo(asyncEvents: [], syncEvents: [STORED_PAYMENT_METHOD_DELETE_REQUESTED])
	...
	paymentMethodProcessTokenization(
		...
		@doc(category: "Payments")
		@webhookEventsInfo(asyncEvents: [], syncEvents: [PAYMENT_METHOD_PROCESS_TOKENIZATION_SESSION])
	...
	orderAddNote(
		...
		@doc(category: "Orders")
		@deprecated(reason: "This field will be removed in Saleor 4.0. Use "orderNoteAdd" instead.")
	...
	orderFulfillmentApprove(
		...
		@doc(category: "Orders")
		@webhookEventsInfo(asyncEvents: [FULFILLMENT_APPROVED], syncEvents: [])
	...
	orderFulfillmentUpdateTracking(
		...
		@doc(category: "Orders")
		@webhookEventsInfo(asyncEvents: [FULFILLMENT_TRACKING_NUMBER_UPDATED], syncEvents: [])
	...
	menuCreate(
		...
		@doc(category: "Menu")
		@webhookEventsInfo(asyncEvents: [MENU_CREATED], syncEvents: [])
	...
	menuDelete(
		...
		@doc(category: "Menu")
		@webhookEventsInfo(asyncEvents: [MENU_DELETED], syncEvents: [])
	...
	menuUpdate(
		...
		@doc(category: "Menu")
		@webhookEventsInfo(asyncEvents: [MENU_UPDATED], syncEvents: [])
	...
	menuItemCreate(
		...
		@doc(category: "Menu")
		@webhookEventsInfo(asyncEvents: [MENU_ITEM_CREATED], syncEvents: [])
	...
	menuItemDelete(
		...
		@doc(category: "Menu")
		@webhookEventsInfo(asyncEvents: [MENU_ITEM_DELETED], syncEvents: [])
	...
	menuItemUpdate(
		...
		@doc(category: "Menu")
		@webhookEventsInfo(asyncEvents: [MENU_ITEM_UPDATED], syncEvents: [])
	...
	invoiceRequest(
		...
		@doc(category: "Orders")
		@webhookEventsInfo(asyncEvents: [INVOICE_REQUESTED], syncEvents: [])
	...
	invoiceRequestDelete(
		...
		@doc(category: "Orders")
		@webhookEventsInfo(asyncEvents: [INVOICE_DELETED], syncEvents: [])
	...
	invoiceSendNotification(
		...
		@doc(category: "Orders")
		@webhookEventsInfo(asyncEvents: [INVOICE_SENT, NOTIFY_USER], syncEvents: [])
	...
	giftCardActivate(
		...
		@doc(category: "Gift cards")
		@webhookEventsInfo(asyncEvents: [GIFT_CARD_STATUS_CHANGED], syncEvents: [])
	...
	giftCardCreate(
		...
		@doc(category: "Gift cards")
		@webhookEventsInfo(asyncEvents: [GIFT_CARD_CREATED, NOTIFY_USER], syncEvents: [])
	...
	giftCardDelete(
		...
		@doc(category: "Gift cards")
		@webhookEventsInfo(asyncEvents: [GIFT_CARD_DELETED], syncEvents: [])
	...
	giftCardUpdate(
		...
		@doc(category: "Gift cards")
		@webhookEventsInfo(asyncEvents: [GIFT_CARD_UPDATED], syncEvents: [])
	...
	giftCardResend(
		...
		@doc(category: "Gift cards")
		@webhookEventsInfo(asyncEvents: [NOTIFY_USER], syncEvents: [])
	...
	promotionCreate(
		...
		@doc(category: "Discounts")
		@webhookEventsInfo(asyncEvents: [PROMOTION_CREATED, PROMOTION_STARTED], syncEvents: [])
	...
	promotionUpdate(
		...
		@doc(category: "Discounts")
		@webhookEventsInfo(
			asyncEvents: [PROMOTION_UPDATED, PROMOTION_STARTED, PROMOTION_ENDED]
			syncEvents: []
		)
	...
	promotionDelete(
		...
		@doc(category: "Discounts")
		@webhookEventsInfo(asyncEvents: [PROMOTION_DELETED], syncEvents: [])
	...
	promotionRuleCreate(
		...
		@doc(category: "Discounts")
		@webhookEventsInfo(asyncEvents: [PROMOTION_RULE_CREATED], syncEvents: [])
	...
	promotionRuleUpdate(
		...
		@doc(category: "Discounts")
		@webhookEventsInfo(asyncEvents: [PROMOTION_RULE_UPDATED], syncEvents: [])
	...
	promotionRuleDelete(
		...
		@doc(category: "Discounts")
		@webhookEventsInfo(asyncEvents: [PROMOTION_RULE_DELETED], syncEvents: [])
	...
	saleCreate(
		...
		@doc(category: "Discounts")
		@webhookEventsInfo(asyncEvents: [SALE_CREATED], syncEvents: [])
	...
	saleDelete(
		...
		@doc(category: "Discounts")
		@webhookEventsInfo(asyncEvents: [SALE_DELETED], syncEvents: [])
	...
	saleUpdate(
		...
		@doc(category: "Discounts")
		@webhookEventsInfo(asyncEvents: [SALE_UPDATED, SALE_TOGGLE], syncEvents: [])
	...
	saleCataloguesAdd(
		...
		@doc(category: "Discounts")
		@webhookEventsInfo(asyncEvents: [SALE_UPDATED], syncEvents: [])
	...
	voucherCreate(
		...
		@doc(category: "Discounts")
		@webhookEventsInfo(asyncEvents: [VOUCHER_CREATED, VOUCHER_CODES_CREATED], syncEvents: [])
	...
	voucherDelete(
		...
		@doc(category: "Discounts")
		@webhookEventsInfo(asyncEvents: [VOUCHER_DELETED], syncEvents: [])
	...
	voucherUpdate(
		...
		@doc(category: "Discounts")
		@webhookEventsInfo(asyncEvents: [VOUCHER_UPDATED, VOUCHER_CODES_CREATED], syncEvents: [])
	...
	voucherCataloguesAdd(
		...
		@doc(category: "Discounts")
		@webhookEventsInfo(asyncEvents: [VOUCHER_UPDATED], syncEvents: [])
	...
	voucherCodeBulkDelete(
		...
		@doc(category: "Discounts")
		@webhookEventsInfo(asyncEvents: [VOUCHER_CODES_DELETED], syncEvents: [])
	...
	exportProducts(
		...
		@doc(category: "Products")
		@webhookEventsInfo(asyncEvents: [NOTIFY_USER, PRODUCT_EXPORT_COMPLETED], syncEvents: [])
	...
	exportGiftCards(
		...
		@doc(category: "Gift cards")
		@webhookEventsInfo(asyncEvents: [NOTIFY_USER, GIFT_CARD_EXPORT_COMPLETED], syncEvents: [])
	...
	exportVoucherCodes(
		...
		@doc(category: "Discounts")
		@webhookEventsInfo(asyncEvents: [VOUCHER_CODE_EXPORT_COMPLETED], syncEvents: [])
	...
	checkoutAddPromoCode(
		...
		@doc(category: "Checkout")
		@webhookEventsInfo(asyncEvents: [CHECKOUT_UPDATED], syncEvents: [])
	...
	checkoutCreate(
		...
		@doc(category: "Checkout")
		@webhookEventsInfo(asyncEvents: [CHECKOUT_CREATED], syncEvents: [])
	...
	checkoutLineDelete(
		...
		@webhookEventsInfo(asyncEvents: [CHECKOUT_UPDATED], syncEvents: [])
		@deprecated(
			reason: "This field will be removed in Saleor 4.0. Use "checkoutLinesDelete" instead."
		)
	...
	channelCreate(
		...
		@doc(category: "Channels")
		@webhookEventsInfo(asyncEvents: [CHANNEL_CREATED], syncEvents: [])
	...
	channelUpdate(
		...
		@doc(category: "Channels")
		@webhookEventsInfo(asyncEvents: [CHANNEL_UPDATED, CHANNEL_METADATA_UPDATED], syncEvents: [])
	...
	channelDelete(
		...
		@doc(category: "Channels")
		@webhookEventsInfo(asyncEvents: [CHANNEL_DELETED], syncEvents: [])
	...
	channelActivate(
		...
		@doc(category: "Channels")
		@webhookEventsInfo(asyncEvents: [CHANNEL_STATUS_CHANGED], syncEvents: [])
	...
	attributeCreate(
		...
		@doc(category: "Attributes")
		@webhookEventsInfo(asyncEvents: [ATTRIBUTE_CREATED], syncEvents: [])
	...
	attributeDelete(
		...
		@doc(category: "Attributes")
		@webhookEventsInfo(asyncEvents: [ATTRIBUTE_DELETED], syncEvents: [])
	...
	attributeUpdate(
		...
		@doc(category: "Attributes")
		@webhookEventsInfo(asyncEvents: [ATTRIBUTE_UPDATED], syncEvents: [])
	...
	attributeBulkUpdate(
		...
		@doc(category: "Attributes")
		@webhookEventsInfo(
			asyncEvents: [ATTRIBUTE_UPDATED, ATTRIBUTE_VALUE_CREATED, ATTRIBUTE_VALUE_DELETED]
			syncEvents: []
		)
	...
	attributeValueBulkDelete(
		...
		@doc(category: "Attributes")
		@webhookEventsInfo(asyncEvents: [ATTRIBUTE_VALUE_DELETED, ATTRIBUTE_UPDATED], syncEvents: [])
	...
	attributeValueCreate(
		...
		@doc(category: "Attributes")
		@webhookEventsInfo(asyncEvents: [ATTRIBUTE_VALUE_CREATED, ATTRIBUTE_UPDATED], syncEvents: [])
	...
	attributeValueUpdate(
		...
		@doc(category: "Attributes")
		@webhookEventsInfo(asyncEvents: [ATTRIBUTE_VALUE_UPDATED, ATTRIBUTE_UPDATED], syncEvents: [])
	...
	appCreate(
		...
		@doc(category: "Apps")
		@webhookEventsInfo(asyncEvents: [APP_INSTALLED], syncEvents: [])
	...
	appActivate(
		...
		@doc(category: "Apps")
		@webhookEventsInfo(asyncEvents: [APP_STATUS_CHANGED], syncEvents: [])
	...
	requestPasswordReset(
		...
		@doc(category: "Users")
		@webhookEventsInfo(
			asyncEvents: [NOTIFY_USER, ACCOUNT_SET_PASSWORD_REQUESTED, STAFF_SET_PASSWORD_REQUESTED]
			syncEvents: []
		)
	...
	sendConfirmationEmail(
		...
		@doc(category: "Users")
		@webhookEventsInfo(asyncEvents: [NOTIFY_USER, ACCOUNT_CONFIRMATION_REQUESTED], syncEvents: [])
	...
	confirmAccount(
		...
		@doc(category: "Users")
		@webhookEventsInfo(asyncEvents: [ACCOUNT_CONFIRMED], syncEvents: [])
	...
	requestEmailChange(
		...
		@doc(category: "Users")
		@webhookEventsInfo(asyncEvents: [NOTIFY_USER, ACCOUNT_CHANGE_EMAIL_REQUESTED], syncEvents: [])
	...
	confirmEmailChange(
		...
		@doc(category: "Users")
		@webhookEventsInfo(
			asyncEvents: [CUSTOMER_UPDATED, NOTIFY_USER, ACCOUNT_EMAIL_CHANGED]
			syncEvents: []
		)
	...
	accountAddressCreate(
		...
		@doc(category: "Users")
		@webhookEventsInfo(asyncEvents: [CUSTOMER_UPDATED, ADDRESS_CREATED], syncEvents: [])
	...
	accountAddressUpdate(
		...
		@doc(category: "Users")
		@webhookEventsInfo(asyncEvents: [ADDRESS_UPDATED], syncEvents: [])
	...
	accountAddressDelete(
		...
		@doc(category: "Users")
		@webhookEventsInfo(asyncEvents: [ADDRESS_DELETED], syncEvents: [])
	...
	accountSetDefaultAddress(
		...
		@doc(category: "Users")
		@webhookEventsInfo(asyncEvents: [CUSTOMER_UPDATED], syncEvents: [])
	...
	accountUpdate(
		...
		@doc(category: "Users")
		@webhookEventsInfo(asyncEvents: [CUSTOMER_UPDATED, CUSTOMER_METADATA_UPDATED], syncEvents: [])
	...
	accountRequestDeletion(
		...
		@doc(category: "Users")
		@webhookEventsInfo(asyncEvents: [NOTIFY_USER, ACCOUNT_DELETE_REQUESTED], syncEvents: [])
	...
	accountDelete(
		...
		@doc(category: "Users")
		@webhookEventsInfo(asyncEvents: [ACCOUNT_DELETED], syncEvents: [])
	...
	addressCreate(
		...
		@doc(category: "Users")
		@webhookEventsInfo(asyncEvents: [ADDRESS_CREATED], syncEvents: [])
	...
	customerDelete(
		...
		@doc(category: "Users")
		@webhookEventsInfo(asyncEvents: [CUSTOMER_DELETED], syncEvents: [])
	...
	staffCreate(
		...
		@doc(category: "Users")
		@webhookEventsInfo(
			asyncEvents: [STAFF_CREATED, NOTIFY_USER, STAFF_SET_PASSWORD_REQUESTED]
			syncEvents: []
		)
	...
	staffUpdate(
		...
		@doc(category: "Users")
		@webhookEventsInfo(asyncEvents: [STAFF_UPDATED], syncEvents: [])
	...
	staffDelete(
		...
		@doc(category: "Users")
		@webhookEventsInfo(asyncEvents: [STAFF_DELETED], syncEvents: [])
	...
	permissionGroupCreate(
		...
		@doc(category: "Users")
		@webhookEventsInfo(asyncEvents: [PERMISSION_GROUP_CREATED], syncEvents: [])
	...
	permissionGroupUpdate(
		...
		@doc(category: "Users")
		@webhookEventsInfo(asyncEvents: [PERMISSION_GROUP_UPDATED], syncEvents: [])
	...
	permissionGroupDelete(
		...
		@doc(category: "Users")
		@webhookEventsInfo(asyncEvents: [PERMISSION_GROUP_DELETED], syncEvents: [])
}
...
type WebhookCreate @doc(category: "Webhooks") {
	webhookErrors: [WebhookError!]!
		@deprecated(reason: "This field will be removed in Saleor 4.0. Use "errors" field instead.")
	errors: [WebhookError!]!
	webhook: Webhook
}
...
type CheckoutCreate
	...
	"""
	created: Boolean
		@deprecated(reason: "This field will be removed in Saleor 4.0. Always returns "true".")
	checkoutErrors: [CheckoutError!]!
		@deprecated(reason: "This field will be removed in Saleor 4.0. Use "errors" field instead.")
	errors: [CheckoutError!]!
	checkout: Checkout
...
type AppUpdate
	@doc(category: "Apps")
	@webhookEventsInfo(asyncEvents: [APP_UPDATED], syncEvents: []) {
	appErrors: [AppError!]!
		@deprecated(reason: "This field will be removed in Saleor 4.0. Use "errors" field instead.")
	errors: [AppError!]!
	app: App
...
type AppDelete
	@doc(category: "Apps")
	@webhookEventsInfo(asyncEvents: [APP_DELETED], syncEvents: []) {
	appErrors: [AppError!]!
		@deprecated(reason: "This field will be removed in Saleor 4.0. Use "errors" field instead.")
	errors: [AppError!]!
	app: App
