<script lang="ts">
	...
	const handleUpdateStaff = async () => {
		...
		if (checkIfGraphqlResultHasError(result, 'staffUpdate', $tranFunc('staff.updateStaffSuccess')))
			return;
	...
	const handleOpenDeleteModal = () => {
		ALERT_MODAL_STORE.openAlertModal({
			content: $tranFunc('staff.deleteStaffConfirm'),
	...
	const handleDeleteStaff = async () => {
		...
		if (checkIfGraphqlResultHasError(result, 'staffDelete', $tranFunc('staff.deleteStaffSuccess')))
			return;
