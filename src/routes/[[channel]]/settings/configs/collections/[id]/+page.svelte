...
{:else if $collectionDetail.data}
	<div class="flex gap-2 flex-row">
		<div class="w-7/10 flex flex-col gap-2">
			<GeneralInformationForm isCreatePage={false} name={collectionUpdateinput.name as string} description={collectionUpdateinput.description as any} media={collectionUpdateinput.backgroundImage as MediaObject | null} metadata={collectionUpdateinput.metadata as any} privateMetadata={collectionUpdateinput.privateMetadata as any} backgroundImageAlt={collectionUpdateinput.backgroundImageAlt as string} />
