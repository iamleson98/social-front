...
const config = {
        ...
        kit: {
                ...
                adapter: (process.env.RUNTIME === 'cloudflare' ? cloudFlareAdapter : autoAdapter)({
                ...
                prerender: {
                        concurrency: 5,
                        // NOTE: previously 'ignore', which silently swallowed
                        // prerendering failures (broken pages ship unnoticed).
                        // 'warn' keeps the build green while surfacing issues.
